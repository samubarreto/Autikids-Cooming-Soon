...
const translations = {
  pt: {
    ...
    sec_7_li3: "<strong>Firebase Crashlytics:</strong> Utilizado para coletar logs de erro e falhas técnicas (que são informações técnicas geradas automaticamente pelo sistema no momento em que o aplicativo apresenta uma falha, como travamentos ou fechamentos inesperados). Esses dados são coletados de forma anônima e servem exclusivamente para que nossa equipe técnica identifique e corrija problemas, garantindo que o Autkids funcione com estabilidade.",
  ...
  es: {
    ...
    sec_7_li3: "<strong>Firebase Crashlytics:</strong> Utilizado para recopilar registros de errores y fallos técnicos (que son informaciones técnicas generadas automáticamente por el sistema en el momento en que la aplicación presenta un fallo, como bloqueos o cierres inesperados). Estos datos se recopilan de forma anónima y sirven exclusivamente para que nuestro equipo técnico identifique y corrija problemas, garantizando que Autkids funcione con estabilidad.",
