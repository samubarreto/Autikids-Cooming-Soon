const translations = {
    pt: {
      ...
      sec_4_text: "O Autikids oferece versões gratuitas e pagas (Premium). As assinaturas são renovadas automaticamente, a menos que sejam canceladas pelo menos 24 horas antes do fim do período atual nas configurações da sua conta da loja de aplicativos (Google Play ou App Store).",
      ...
      sec_7_text: "Para dúvidas sobre estes termos, entre em contato através do e-mail: suporte@autikids.com",
    ...
    en: {
      ...
      sec_4_text: "Autikids offers free and paid (Premium) versions. Subscriptions renew automatically unless canceled at least 24 hours before the end of the current period in your app store account settings (Google Play or App Store).",
      ...
      sec_7_text: "For questions regarding these terms, please contact us via email: suporte@autikids.com",
    ...
    es: {
      ...
      sec_4_text: "Autikids ofrece versiones gratuitas y de pago (Premium). Las suscripciones se renuevan automáticamente a menos que se cancelen al menos 24 horas antes del final del período actual en la configuración de su cuenta de la tienda de aplicaciones (Google Play o App Store).",
      ...
      sec_7_text: "Para dudas sobre estos términos, contáctenos a través del correo: suporte@autikids.com",
